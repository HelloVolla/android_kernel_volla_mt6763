...
static void lcm_get_params(/*struct*/ LCM_PARAMS *params)
{
  ...
  params->dsi.lcm_esd_check_table[1].para_list[3] = 0x00;	
	...
	*/
	...
	params->dsi.lcm_esd_check_table[2].para_list[1] = 0x09;
	params->dsi.lcm_esd_check_table[2].para_list[2] = 0x16;
	params->dsi.lcm_esd_check_table[2].para_list[3] = 0x20;
	params->dsi.lcm_esd_check_table[2].para_list[4] = 0x24;
	params->dsi.lcm_esd_check_table[2].para_list[5] = 0x2A;
	params->dsi.lcm_esd_check_table[2].para_list[6] = 0x2F;
	params->dsi.lcm_esd_check_table[2].para_list[7] = 0x2E;
	params->dsi.lcm_esd_check_table[2].para_list[8] = 0x62;
	params->dsi.lcm_esd_check_table[2].para_list[9] = 0x75;	
...
{
    //printk("hx8394f_dsi_vdo_t20 lcm_init *****");
