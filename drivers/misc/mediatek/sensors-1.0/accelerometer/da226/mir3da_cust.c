...
//prize-add wyq 20181127 add hardware info-start
#if defined(CONFIG_PRIZE_HARDWARE_INFO)
     strcpy(current_gsensor_info.chip,"da226");
     sprintf(current_gsensor_info.id,"0x%04x",client->addr);
     strcpy(current_gsensor_info.vendor,"MirMEMS");
