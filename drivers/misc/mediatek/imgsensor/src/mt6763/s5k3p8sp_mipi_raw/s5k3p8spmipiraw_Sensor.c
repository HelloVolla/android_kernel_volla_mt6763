...
extern kal_bool s5k3p8sp_Read_Awb_Otp(kal_uint16 Awb_otp_start_addr, u16 Outdatalen,unsigned char * pOutputdata);


static kal_uint8 s5k3p8sp_awb_data[AWB_DATA_SIZE] = {0};

static void s5k3p8sp_apply_awb(void)
{
	...
	s5k3p8sp_Read_Awb_Otp(0x0006,AWB_DATA_SIZE,s5k3p8sp_awb_data);
	rg = (s5k3p8sp_awb_data[0] << 8) | s5k3p8sp_awb_data[1];
	bg = (s5k3p8sp_awb_data[2] << 8) | s5k3p8sp_awb_data[3];
	golden_rg = (s5k3p8sp_awb_data[4] << 8) | s5k3p8sp_awb_data[5];
	golden_bg = (s5k3p8sp_awb_data[6] << 8) | s5k3p8sp_awb_data[7];
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			*sensor_id = ((read_cmos_sensor_8(0x0000) << 8) | read_cmos_sensor_8(0x0001));
			...
			if(*sensor_id ==0x3108)
				*sensor_id =0x3118;
			printk("fsd---s5k3p8sp get_imgsensor_id id is 0x%x\n",*sensor_id);
			...
			if (((*sensor_id ==imgsensor_info.sensor_id) && ( year > 0x12  ||month > 0x03))) {
