...
struct REGULATOR_CTRL regulator_control[REGULATOR_TYPE_MAX_NUM] = {
	...
	{"vcamio"},
	{"vcamaf"},
	/*zhengjiang.zhu@Koobee.Camera.Driver  2018/10/27  modify for subcamera power */
#if defined(CONFIG_PROJECT_KOOBEE_K605) || defined(CONFIG_PROJECT_KOOBEE_K6305) || defined(CONFIG_PROJECT_KOOBEE_K6073)  || defined(CONFIG_PROJECT_KOOBEE_K6303)
	{"vcama"}, //vcama_sub fsd prize 
	{"vcamd"},//vcamd_sub fsd prize 
	{"vcamio"},//vcamio_sub fsd prize 
#else
	{"vcama_sub"}, //vcama_sub fsd prize 
	{"vcamd_sub"},//vcamd_sub fsd prize 
	{"vcamio_sub"},//vcamio_sub fsd prize 
#endif
