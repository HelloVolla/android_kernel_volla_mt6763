...
struct IMGSENSOR_HW_CFG imgsensor_custom_config[] = {
	{
		...
		IMGSENSOR_I2C_DEV_0,
		{
			...
			/*zhengjiang.zhu@Koobee.Camera.Driver  2018/11/02  add for main camera avdd*/
			#if defined(CONFIG_PROJECT_KOOBEE_K6305) || defined(CONFIG_PROJECT_KOOBEE_K6303)
			{IMGSENSOR_HW_ID_GPIO, IMGSENSOR_HW_PIN_AVDD},//{IMGSENSOR_HW_ID_GPIO, IMGSENSOR_HW_PIN_AVDD},
			#else
			{IMGSENSOR_HW_ID_REGULATOR, IMGSENSOR_HW_PIN_AVDD},//{IMGSENSOR_HW_ID_GPIO, IMGSENSOR_HW_PIN_AVDD},	
			#endif
			/*zhengjiang.zhu@Koobee.Camera.Driver  2018/11/02  end for main camera avdd*/
			{IMGSENSOR_HW_ID_REGULATOR, IMGSENSOR_HW_PIN_DOVDD},
			{IMGSENSOR_HW_ID_REGULATOR, IMGSENSOR_HW_PIN_AFVDD},
			{IMGSENSOR_HW_ID_GPIO, IMGSENSOR_HW_PIN_CAMAFEN},
	...
	},
	{
		...
		{
			{IMGSENSOR_HW_ID_MCLK, IMGSENSOR_HW_PIN_MCLK},
			/*zhengjiang.zhu@Koobee.Camera.Driver  2018/10/27  add for subcamera power*/
			#if defined(CONFIG_PROJECT_KOOBEE_K6305)  || defined(CONFIG_PROJECT_KOOBEE_K6303)
			{IMGSENSOR_HW_ID_GPIO, IMGSENSOR_HW_PIN_AVDD},//{IMGSENSOR_HW_ID_GPIO, IMGSENSOR_HW_PIN_AVDD},
			#else
			{IMGSENSOR_HW_ID_REGULATOR, IMGSENSOR_HW_PIN_AVDD},//{IMGSENSOR_HW_ID_GPIO, IMGSENSOR_HW_PIN_AVDD},	
			#endif			
			{IMGSENSOR_HW_ID_REGULATOR, IMGSENSOR_HW_PIN_DOVDD},
			{IMGSENSOR_HW_ID_REGULATOR, IMGSENSOR_HW_PIN_DVDD},//{IMGSENSOR_HW_ID_GPIO, IMGSENSOR_HW_PIN_DVDD},
			/*zhengjiang.zhu@Koobee.Camera.Driver  2018/10/27  end for subcamera power*/
			{IMGSENSOR_HW_ID_GPIO, IMGSENSOR_HW_PIN_PDN},
			{IMGSENSOR_HW_ID_GPIO, IMGSENSOR_HW_PIN_RST},
			{IMGSENSOR_HW_ID_NONE, IMGSENSOR_HW_PIN_NONE},
		},
...
#endif
//prize end
//prize-add-pengzhipeng-20190506-start
...
/*zhengjiang.zhu@prize.Camera.Driver  2018/11/02  end for gc8034*/
