 ...
 *
 ****************************************************************************/
#ifndef _GC13023MIPI_SENSOR_H
#define _GC13023MIPI_SENSOR_H

#define BINNING_PREVIEW        1

#define PDAFSUPPORT            0

/* SENSOR MIRROR FLIP INFO */
#define GC13023_MIRROR_FLIP_ENABLE         1
#if GC13023_MIRROR_FLIP_ENABLE
#define GC13023_MIRROR         0xd6
#else
#define GC13023_MIRROR         0xd5
#endif
...
struct gc13023_otp {
	...
	kal_uint8  dd_flag;
	kal_uint8  pdaf_flag;
	kal_uint8  package_flag;
	kal_uint8  version_flag;
	kal_uint8  sensor_version;
	kal_uint8  driver_version;
	kal_uint8  reg_flag;
	kal_uint8  reg_num;
...
extern bool gc13023_read_eeprom(kal_uint16 addr, BYTE *data, kal_uint32 size);
#endif
