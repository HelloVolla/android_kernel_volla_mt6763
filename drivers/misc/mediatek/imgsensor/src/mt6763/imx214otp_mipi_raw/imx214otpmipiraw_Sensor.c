...
#include "imx214otpmipiraw_Sensor.h"
...
static kal_uint32 imx214otp_ATR(UINT16 DarkLimit, UINT16 OverExp)
{
...
*
*************************************************************************/
#define GMS_OTP_VALUE 0x28
static kal_uint16 read_otp_for_gms(void)
{
	write_cmos_sensor(0x0A02, 0x0f); //Select Page
	write_cmos_sensor(0x0A00, 0x01); //Read ON
	return read_cmos_sensor(0x0A04);
}
...
//kin0603
UINT32 IMX214OTP_MIPI_RAW_SensorInit(SENSOR_FUNCTION_STRUCT **pfFunc)
//UINT32 IMX214OTP_MIPI_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
