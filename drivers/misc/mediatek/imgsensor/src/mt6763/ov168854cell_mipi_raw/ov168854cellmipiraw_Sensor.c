...
//extern int curr_sensor_id;	/*prize add by zhuzhengjiang for compate with main:ov16885  sub is ov18665-4cell 2019618 start*/
//prize fengshangdong modify at 20190524
static DEFINE_SPINLOCK(imgsensor_drv_lock);

static imgsensor_info_struct imgsensor_info = {
	.sensor_id = OV168854CELL_MIPI_SENSOR_ID,
...
{ //30fps            //30fps for Normal capture & ZSD
	...
	// Sysclk 160Mhz, MIPI4_768Mbps/Lane, 30Fps.
	// Line_length =1400, Frame_length =3808.  V-blanking=17.99ms
	printk("normal_capture_setting entry \n");
	//write_cmos_sensor_8(0x0100, 0x00);
	write_cmos_sensor_8(0x0301, 0xa5);
	write_cmos_sensor_8(0x0304, 0x28);
	write_cmos_sensor_8(0x0316, 0xa0);
...
{  //full size 24fps for PIP 
       printk("pip_capture_setting entry \n");
	//write_cmos_sensor_8(0x0100, 0x00);
	write_cmos_sensor_8(0x0301, 0xa5);
	write_cmos_sensor_8(0x0304, 0x28);
...
static void pip_capture_15fps_setting(void)
{
    ...
    LOG_INF( "OV168854CELL PIP setting Enter!");

 	/*
	 * @@ OV168854CELL 4lane 4608x3456 15fps
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	kal_uint8 i = 0;
	kal_uint8 retry = 2;
	/*prize add by zhuzhengjiang for compate with main:ov16885  sub is ov18665-4cell 2019618 start*/
	//if(curr_sensor_id != 1)
		//return ERROR_SENSOR_CONNECT_FAIL;
	/*prize add by zhuzhengjiang for compate with main:ov16885  sub is ov18665-4cell 2019618 end*/
...
UINT32 OV168854CELL_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
