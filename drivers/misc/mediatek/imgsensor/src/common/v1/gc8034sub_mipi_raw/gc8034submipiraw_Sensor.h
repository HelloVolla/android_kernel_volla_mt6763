...
/*#define FULLSIZE_PREVIEW*/
  ...
  //#define GC8034SUB_MIRROR_NORMAL
//#define GC8034SUB_MIRROR_H
//#define GC8034SUB_MIRROR_V
//#define GC8034SUB_MIRROR_HV
/*
#if defined(GC8034SUB_MIRROR_NORMAL)
	#define GC8034SUB_MIRROR	0xc0
	#define BinStartY		0x04
	#define BinStartX		0x05
	#define FullStartY		0x08
	#define FullStartX		0x09
#elif defined(GC8034SUB_MIRROR_H)
	#define GC8034SUB_MIRROR	0xc1
	#define BinStartY		0x04
	#define BinStartX		0x05
	#define FullStartY		0x08
	#define FullStartX		0x0b
#elif defined(GC8034SUB_MIRROR_V)
	#define GC8034SUB_MIRROR	0xc2
	#define BinStartY		0x04
	#define BinStartX		0x05
	#define FullStartY		0x08
	#define FullStartX		0x09
#elif defined(GC8034SUB_MIRROR_HV)
