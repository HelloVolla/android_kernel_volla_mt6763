 ...
 *============================================================================
 ****************************************************************************/
#define PFX "S5K2L5SX_camera_sensor"
...
#include "s5k2l5sxmipiraw_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = S5K2L5SX_SENSOR_ID,

	.checksum_value = 0x143d0c73,

	.pre = {	//binning size 30pfs
		.pclk = 560000000,				//record different mode's pclk
		.linelength  = 5728,				//record different mode's linelength
		.framelength = 3256,			//record different mode's framelength
		.startx = 0,					//record different mode's startx of grabwindow
		.starty = 0,					//record different mode's starty of grabwindow
		.grabwindow_width  = 4048,		//record different mode's width of grabwindow
...
static struct SENSOR_WINSIZE_INFO_STRUCT
	...
	{ 4048, 3016,	  0,  	0, 4048, 3016, 4048, 3016,   0,	0, 4048, 3016, 	 0, 0, 4048, 3016}, // Preview
	{ 4048, 3016,	  0,  	0, 4048, 3016, 4048, 3016,   0,	0, 4048, 3016, 	 0, 0, 4048, 3016}, // capture
	{ 4048, 3016,	  0,  	0, 4048, 3016, 4048, 3016,   0,	0, 4048, 3016, 	 0, 0, 4048, 3016}, // video
	{ 4048, 3016,	  0,  	0, 4048, 3016, 4048, 3016,   0,	0, 4048, 3016, 	 0, 0, 4048, 3016}, //hight speed video
	{ 4048, 3016,	  0,  	0, 4048, 3016, 4048, 3016,   0,	0, 4048, 3016, 	 0, 0, 4048, 3016},// slim video
	{ 4048, 3016,	  0,  	0, 4048, 3016, 4048, 3016,   0,	0, 4048, 3016, 	 0, 0, 4048, 3016}, // custom1
};
...
static kal_uint16 addr_data_pair_init_2l5[] = {
	0x6214, 0x7971,
	0x6218, 0x7150,
	0x6230, 0x0000,
	0x0A02, 0x7F00,
...
static void sensor_init(void)
{
	...
	write_cmos_sensor(0x0000, 0x20C5);

	write_cmos_sensor(0x0100, 0x0000);
	mdelay(3);

	table_write_cmos_sensor(addr_data_pair_init_2l5,
				sizeof(addr_data_pair_init_2l5) / sizeof(kal_uint16));

}				/*      sensor_init  */



static kal_uint16 addr_data_pair_pre_2l5[] = {
...
static void preview_setting(void)
{
	...
	table_write_cmos_sensor(addr_data_pair_pre_2l5,
				sizeof(addr_data_pair_pre_2l5) / sizeof(kal_uint16));
...
static kal_uint16 addr_data_pair_cap_2l5[] = {
...
static void capture_setting(kal_uint16 currefps)
{
	...
	table_write_cmos_sensor(addr_data_pair_cap_2l5,
				sizeof(addr_data_pair_cap_2l5) / sizeof(kal_uint16));

	write_cmos_sensor_8(0x0103,0x01);
}

static kal_uint16 addr_data_pair_video_2l5[] = {
...
static void normal_video_setting(kal_uint16 currefps)
{
	...
	table_write_cmos_sensor(addr_data_pair_video_2l5,
				sizeof(addr_data_pair_video_2l5) / sizeof(kal_uint16));

	write_cmos_sensor_8(0x0103,0x01);
}

static kal_uint16 addr_data_pair_hs_2l5[] = {
...
static void hs_video_setting(void)
{
	...
	/*check_streamoff();*/
	table_write_cmos_sensor(addr_data_pair_hs_2l5,
				sizeof(addr_data_pair_hs_2l5) / sizeof(kal_uint16));

	write_cmos_sensor_8(0x0103,0x01);
}

static kal_uint16 addr_data_pair_slim_2l5[] = {
...
static void slim_video_setting(void)
{
	...
	table_write_cmos_sensor(addr_data_pair_slim_2l5,
				sizeof(addr_data_pair_slim_2l5) / sizeof(kal_uint16));
	write_cmos_sensor_8(0x0103,0x01);
}

static kal_uint16 addr_data_pair_custom1_2l5[] = {
...
static void custom1_setting(void)
{
	...
	table_write_cmos_sensor(addr_data_pair_custom1_2l5,
				sizeof(addr_data_pair_custom1_2l5) / sizeof(kal_uint16));
	write_cmos_sensor_8(0x0103,0x01);
}
...
UINT32 S5K2L5SX_MIPI_RAW_SensorInit(
