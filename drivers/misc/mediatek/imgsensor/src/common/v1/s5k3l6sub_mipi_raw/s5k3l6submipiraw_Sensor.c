...
#include "s5k3l6submipiraw_Sensor.h"
...
static imgsensor_info_struct imgsensor_info = {
	.sensor_id = S5K3L6SUB_SENSOR_ID,		//Sensor ID Value: 0x30C8//record sensor id defined in Kd_imgsensor.h
...
{
    LOG_INF("S5K3L6SUB_MIPI_RAW_SensorInit in\n");
	/* To Do : Check Sensor status here */
	if (pfFunc!=NULL)
		*pfFunc=&sensor_func;
	return ERROR_NONE;
}	/*	S5K3L6SUB_MIPI_RAW_SensorInit	*/
