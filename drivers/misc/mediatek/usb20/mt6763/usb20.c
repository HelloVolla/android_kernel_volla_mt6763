...
//prize lsw add for distinguish otg or charge mode 20191024 start
#ifdef CONFIG_PRIZE_LEDS_AW2015
extern void aw2015_charge_mode(int on_off);
#endif
//prize lsw add for distinguish otg or charge mode 20191024 end
