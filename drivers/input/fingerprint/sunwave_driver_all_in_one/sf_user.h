...
// platform select
//prize-wyq 20190514 platform and compatible selected by TEE vendor define in deconfig-start
...
#endif
//prize-wyq 20190514 platform and compatible selected by TEE vendor define in deconfig-end
