 ...
 */
 #if 0
static int fts_ft8006p_init(void)
{
    int i = 0;
    int j = 0;
    u8 temp = 0;
    struct upgrade_func *upgf = &upgrade_func_ft8006p;
 ...
 ***********************************************************************/
 #if 0
static int fts_ft8006p_force_upgrade(struct i2c_client *client, u8 *buf, u32 len)
{
    int ret = 0;
    u8 *tmpbuf = NULL;
    u8 cmd[2] = { 0 };
...
struct upgrade_func upgrade_func_ft8006p = {
    ...
    //.force_upgrade = fts_ft8006p_force_upgrade,
};
