...
char *i_CTPM_firmware_name = "K6503_HLT_Kobee_CIDFF0D_D00_C02_0430-064946.bin";
...
//przie-add-pengzhipeng-20200422-start
	#if defined(CONFIG_PRIZE_HARDWARE_INFO)
	sprintf(current_tp_info.chip,"Himax_FW:0x%02x", ic_data->vendor_touch_cfg_ver);
    sprintf(current_tp_info.id,"0x%04x",(ic_data->vendor_cid_maj_ver << 8 | ic_data->vendor_cid_min_ver));
